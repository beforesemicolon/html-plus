...
describe('HTMLNode', () => {
  ...
  describe('siblings', () => {
    ...
    it('should insert only when correct thing provided', () => {
      ...
      div.insertAdjacentText('afterbegin', new HTMLNode('span'))
      ...
      div.insertAdjacentElement('afterbegin', new HTMLNode('span'))
  ...
  it('should clone node', () => {
    const parent = new HTMLNode('div');
    const anchor = new HTMLNode('a', 'href="path/to/page" download #if="valid === true"');
